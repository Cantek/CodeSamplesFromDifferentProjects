package Drawings
{
	...
	/** EllipseTool: This component is created by Cantek ÇETİN
	 *  EllipseTool for measuring area inside the Ellipse. 
	 */
	...
	public class EllipseTool extends DrawingTool
	{
		...
		{			
			if(startX != endX && startY != endY)
			{
				...
				*/
				var measure:int = 3.14 * (w/2) * horpixelSpacing * (h/2) * verpixelSpacing / (zoomFactor * zoomFactor);
