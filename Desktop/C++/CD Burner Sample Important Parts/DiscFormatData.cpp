...
///////////////////////////////////////////////////////////////////////
//
// CDiskFormat::getInformation about total space and free space
//
//
//

long CDiscFormatData::getTotalSpaceOfMedia()
{
	if(m_discFormatData != NULL)
	{
		//MessageBox(NULL,L"asd asd",NULL,0);
		long allSpace;
		m_discFormatData->get_TotalSectorsOnMedia(&allSpace);
		return allSpace;
	}
	else
		return 0;
...
long CDiscFormatData::getFreeSpaceOfMedia()
{
	if(m_discFormatData != NULL)
	{
		//MessageBox(NULL,L"asd asd",NULL,0);
		long freeSpace;
		m_discFormatData->get_FreeSectorsOnMedia(&freeSpace);
		return freeSpace;
	}
	else
		return 0;
...
bool CDiscFormatData::Burn(HWND hNotificationWnd, IStream* streamData)
{
	...
	m_discFormatData->SetWriteSpeed(1,true);
